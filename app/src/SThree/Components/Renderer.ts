...
export default class Renderer {
    ...
    constructor(main) {
        this.main = main;
        this.props = main.props.renderer;
        ...
        let width = this.props.width??window.innerWidth;
        let height = this.props.height??window.innerHeight;
        ...
        main.renderer.shadowMap.soft = true;
    ...
    resizeCanvasToDisplaySize() {
        ...
        if (this.main.camera) {
            this.main.camera.aspect = (width / height) * 1.1;
